<template>
  <div class="studentOp">
            ...
            <el-table-column
              ...
              <template slot="header" slot-scope="scope" >
                <el-select v-model="select" placeholder="请选择查询" width="80">
                      ...
                      <el-option label="系名称" value="sdpet_name"></el-option>
                      <el-option label="系的简介" value="sdpet_brief"></el-option>
                </el-select>
                <el-input
                  name='search'
                  width="80"
      ...
      <el-dialog :append-to-body="true" title="院系编辑" :visible.sync="dialogFormVisible" class="thisblack-bgc">
          <el-form :model="singalInfo" class="flexForm">
              <el-form-item label="系号" :label-width="formLabelWidth">
                  <el-input v-model="singalInfo.sdept" :placeholder="singalInfo.sno" autocomplete="off" class="popWinInput"></el-input>
              </el-form-item>
              <el-form-item label="系名称" :label-width="formLabelWidth">
                  <el-input v-model="singalInfo.sdpet_name" :placeholder="singalInfo.sname" autocomplete="off" class="popWinInput"></el-input>
              </el-form-item>
              <el-form-item label="系的简介" :label-width="formLabelWidth">
                  <el-input v-model="singalInfo.sdpet_brief" autocomplete="off" class="popWinInput"></el-input>
              </el-form-item>
          </el-form>
...
export default {
  ...
  methods: {
      ...
      async getAgainTableData(){
        const {data:res} = await getDeptInfo()
